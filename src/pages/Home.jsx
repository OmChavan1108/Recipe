    ...
    const sampleRecipes = [
      {
        id: 1,
        name: "Mutton Biryani",
        description:"A flavorful rice dish cooked with marinated Mutton and spices.",
        imageUrl: "/MuttonBiryani1.jpg", // Relative path from public
      },
      {
        id: 2,
        name: "Paneer Butter Masala",
        description:
          "A butter paneer is a rich & creamy curry made with paneer, spices, onions, tomatoes, cashews and butter",
        imageUrl: "/Panner.jpg", // Relative path from public
      },
      {
        id: 3,
        name: "Ice-Cream",
        description: "This ice cream is egg-free and easy to make with pure milk.",
